...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PLACED', 'CONFIRMED', 'PREPARING', 'READY_FOR_PICKUP', 'OUT_FOR_DELIVERY', 'DELIVERED', 'COMPLETED', 'REJECTED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('COD', 'UPI_MANUAL');
...
CREATE TABLE "ShopConfig" (
    "id" TEXT NOT NULL DEFAULT 'shop_config',
    "name" TEXT NOT NULL DEFAULT 'Bite Corner',
    "deliveryFee" DECIMAL(10,2) NOT NULL DEFAULT 0,
    "minOrderValue" DECIMAL(10,2) NOT NULL DEFAULT 0,
...
CREATE TABLE "DeliveryAgentProfile" (
    ...
    CONSTRAINT "DeliveryAgentProfile_pkey" PRIMARY KEY ("userId")
);
